        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('admin.employees.file_import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <button class="btn btn-default">Import Employee</button>
                        <a class="btn btn-success" href="{{ route('admin.employees.file_export') }}">Export Employee</a>
                        <a class="btn btn-info" href="/employee.xlsx">Sample file Download</a>
                    </form>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.employees.edit', $employee->id) }}" class="btn btn-flat btn-info">Edit Employee</a>
                                        <button 
